...
from api.schemas.chatbot_schemas import Conversation, Message, PromptRequest, Quotes
...
from api.services.chat_services.chat_service import conversions_api_get
...
@chatbot_router.post("/currency_conversions")
async def currency_conversions(
    ...
    response = await conversions_api_get(conversions=conversions)
